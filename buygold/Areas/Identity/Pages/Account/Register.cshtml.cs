...
namespace buygold.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(!await _roleManager.RoleExistsAsync(SD.Buyer))
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (role == SD.Buyer)
                    {
                        await _userManager.AddToRoleAsync(user, SD.Buyer);
                    }
                    else
                    {
                        ...
                        else
                        {
                            if (role == SD.Seller)
                            {
                                await _userManager.AddToRoleAsync(user, SD.Seller);
                            }
                            else
                            {
                    ...
                    else
                    {
                        ...
                        {
                            TempData["Success"] = "شما به عنوان فروشنده ثبت نام شدید";
