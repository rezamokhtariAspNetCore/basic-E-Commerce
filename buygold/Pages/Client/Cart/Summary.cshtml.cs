...
namespace buygold.Pages.Client.ShopingCart
{
	[Authorize]
	[BindProperties]
		...
		public void OnGet()
		{
			...
			if (claim != null)
			{
				ShoppingCartList = _unitOfWork.ShoppingCart.GetAll(filter: u => u.ApplicationUserId == claim.Value,
					includeProperties: "MenuItem,MenuItem.GameType,MenuItem.Category");
			...
			if (claim != null)
			{
					...
					PaymentMethodTypes = new List<string>
				{
				  "card",
					...
					Mode = "payment",
					SuccessUrl = domain + $"Client/cart/OrderConfirmation?id={OrderHeader.Id}",
